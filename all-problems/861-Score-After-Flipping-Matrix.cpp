...
//       RIGHTMOST BIT MUST BE SET (TOGGLE THAT ROW)
//     - FOR EVERY COLOUMN, COUNT NUMBER OF SET AND UNSET BIT. IF NUMBER OF SET BIT IS LESS THAN
//       NUMBER OF UNSET BIT, THEN TOGGLE THAT COLOUMN
